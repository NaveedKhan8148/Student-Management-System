...
import {
    ...
    Spin, DatePicker, Select, Input, Space, Avatar, Badge, 
...
const ParentAttendance = () => {
    ...
    // Filter client-side by status and search
        ...
        },
        {
            ...
            render: (_, record) => {
                ...
                if (record.status === 'Present') {
                    return <Text type="secondary">On time</Text>;
                }
    ...
    return (
        <div>
            ...
            <div style={{ marginBottom: 24 }}>
                ...
                <Text type="secondary">
                    Track attendance records for <strong>{child.studentName}</strong> ({child.rollNo})
                </Text>
            </div>
            ...
            <Card style={{ marginBottom: 16, borderRadius: '10px' }}>
                <Space wrap size="middle" style={{ width: '100%' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'flex-end' }}>
                        <Button 
                            icon={<ReloadOutlined />} 
                            onClick={() => fetchAttendance(child._id)}
                            size="large"
                        >
                            Refresh
                        </Button>
